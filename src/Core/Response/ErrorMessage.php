...
class ErrorMessage
{
    ...
    public static function parseError(string $errorInfoCode)
    {
        $errorMessageCollection = (new self)->errorMessageCollection();

        if (array_key_exists($errorInfoCode, $errorMessageCollection)) {
            return $errorMessageCollection[$errorInfoCode];
        }

        return '原因不明のエラーが発生しました。';
    }

    private function errorMessageCollection()
    {
        return [
            'E00000000' => '特になし',
